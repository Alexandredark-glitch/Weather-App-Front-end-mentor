...
import { searchPlaces } from "../Store/weatherData";
      ...
      <div className=" flex flex-wrap flex-col items-center mb-12 relative z-40">
        ...
        <div className=" lg:mr-4 flex flex-col sm:flex-row w-full max-w-2xl gap-6 relative">
          ...
          <button
            ...
            className="focus:outline-none focus:ring-2 focus-within:ring-my-blue-700 bg-my-blue-500 hover:bg-my-blue-700 text-white px-8 py-4 rounded-xl font-semibold transition-colors cursor-pointer"
          >
            Search
          </button>
        </div>
